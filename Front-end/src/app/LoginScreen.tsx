...
import { KeyRound, Leaf, LoaderCircle } from "lucide-react";
import {
  type AuthAdapter,
        ...
        <div className="rounded-[20px] border border-[#E5DDD3] bg-white p-6 shadow-[0_20px_60px_rgba(73,47,32,0.08)] sm:p-8">
          ...
          <form className="mt-7 space-y-4" onSubmit={submit} noValidate>
            <div>
              ...
              />
              {errors.email && (
                <p id="auth-email-error" className="mt-1.5 text-xs font-semibold text-[#B8443C]">
                  {errors.email}
                </p>
              )}
            </div>
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label htmlFor="auth-password" className="text-sm font-bold text-[#403832]">
                  Password
                </label>
                {mode === "login" && (
                  <button
                    ...
                    className="text-xs font-semibold text-[#7A3E24] hover:underline"
                  >
                    Forgot password?
                  </button>
                )}
              ...
              />
              {errors.password && (
                <p id="auth-password-error" className="mt-1.5 text-xs font-semibold text-[#B8443C]">
                  {errors.password}
                </p>
              )}
            </div>
              ...
              <div>
                ...
                {(errors as SignupErrors).passwordConfirmation && (
                  <p
                    ...
                    className="mt-1.5 text-xs font-semibold text-[#B8443C]"
                  >
                    {(errors as SignupErrors).passwordConfirmation}
                  </p>
                )}
